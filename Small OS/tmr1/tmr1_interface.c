...
/*============= global variables =============*/
static  void (*gl_ov_callBackPtr)	(void) = NULL_PTR;
static  void (*gl_cmpa_callBackPtr)	(void) = NULL_PTR;
static  void (*gl_cmpb_callBackPtr)	(void) = NULL_PTR;
static  void (*gl_icu_callBackPtr)	(void) = NULL_PTR;
...
{
	if(gl_cmpb_callBackPtr != NULL_PTR)
	{
		gl_cmpb_callBackPtr();
	}
}
...
{
	if(gl_cmpa_callBackPtr != NULL_PTR)
	{
		gl_cmpa_callBackPtr();
	}
}
...
{
	if(gl_icu_callBackPtr != NULL_PTR)
	{
		gl_icu_callBackPtr();
	}
}